"use client";
import { rugbyPlayer, TeamCard } from "@/types/RugbyMatch";
...
const TestPage = () => {
  ...
  const [homeTeam, setHomeTeam] = useState<TeamCard>({
    ...emptyTeam,
    players: homeTeamPlayers,
  });
  const [awayTeam, setAwayTeam] = useState<TeamCard>({
    ...emptyTeam,
                  ...
                  <div className="flex flex-col items-center justify-center gap-2 w-full">
                    ...
                    <div className="flex flex-row items-center justify-center gap-2 w-full">
                      <div
                        ...
                        style={{
                          backgroundColor: homeTeam.color_1 || "skeleton",
                        }}
                      ></div>
                      <div
                        className="w-1/3 h-8 border border-primary-content/50 rounded"
                        style={{
                          backgroundColor: homeTeam.color_2 || "skeleton",
                        }}
                      ></div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col items-center justify-center gap-2 w-full">
                    ...
                    <div className="flex flex-row items-center justify-center gap-2 w-full">
                      <div
                        className="w-1/3 h-8 border border-primary-content/50 rounded"
                        style={{
                          backgroundColor: awayTeam.color_1 || "skeleton",
                        }}
                      ></div>
                      <div
                        className="w-1/3 h-8 border border-primary-content/50 rounded"
                        style={{
                          backgroundColor: awayTeam.color_2 || "skeleton",
                        }}
                      ></div>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-6 gap-2">
                  {homeTeamPlayers.map((player, index) => (
                    ...
                    >
                      ...
                      <button
                        type="button"
                        className="btn btn-error btn-sm btn-square flex frlx-col items-center justify-center"
                        onClick={() => {
                          setHomeTeamPlayers((prev) =>
